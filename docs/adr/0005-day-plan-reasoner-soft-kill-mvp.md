...
In ARCHITETTURA_V3.md §21 viene introdotta una nuova sotto-sezione **"Codice congelato — index"** che lista TUTTI i pezzi soft-killed (oggi: Wake Word + Day Plan Reasoner). Diventa la mappa di riattivazione: chi torna a guardare il repo in 6 mesi vede subito cosa parcheggiare e cosa riprendere.
...
- `docs/ARCHITETTURA_V3.md §21` — sotto-sezione "Codice congelato — index"
