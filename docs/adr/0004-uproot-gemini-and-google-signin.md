...
Il design originale di GIGI v3 (`docs/ARCHITETTURA_V3.md`) prevedeva una cascade a 4 livelli per il reasoning lato app:
...
- `docs/ARCHITETTURA_V3.md` §13 — sezione Gemini Live storica marcata RIMOSSO
