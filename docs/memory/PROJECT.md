...
Riferimento canonico: `docs/ARCHITETTURA_V3.md` (paper tecnico V3 "True Agent", aprile 2026 rev. 2).
...
1. **Jarvis, non Siri** — agente che ragiona, pianifica, chiama tool, e decide il passo successivo autonomamente (vedi `ARCHITETTURA_V3.md` §1).
