...
Riferimento canonico: `docs/rework/Architecture-Armando-Revision.md` (paper tecnico V3 "True Agent", aprile 2026 rev. 2).
...
1. **Jarvis, non Siri** — agente che ragiona, pianifica, chiama tool, e decide il passo successivo autonomamente (vedi `../rework/Architecture-Armando-Revision.md` §1).
