...
| # | Severity | Title | File |
|---|---|---|---|
| 001 | P2 | Dashboard shows setup prompts on first run — copy unclear | [2026-05-12-001-dashboard-onboarding-copy.md](2026-05-12-001-dashboard-onboarding-copy.md) |
...
_(empty — move rows from Open above when fixed; keep the .md file in this folder with `**Status**: ✅ fixed` + filled `## Resolution` section)_
