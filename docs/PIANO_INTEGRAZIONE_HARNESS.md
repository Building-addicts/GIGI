...
- [ ] **14.3** `server/api/ios-computer-use.js` — loop Anthropic Computer Use (ref: `rework/Architecture-Armando-Revision.md §9`)
...
- [ ] **18.2** Aggiorna `rework/Architecture-Armando-Revision.md` §9.BIS con architettura finale
