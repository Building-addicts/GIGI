        ...
        Section {
            HStack(alignment: .top, spacing: 12) {
                ...
                VStack(alignment: .leading, spacing: 4) {
                    Text("Double-tap the back of your iPhone")
                        .font(.subheadline.weight(.semibold))
                    Text("Settings → Accessibility → Touch → Back Tap → Double Tap → Talk to GIGI")
                        .font(.caption)
                        .foregroundColor(.secondary)
                }
            }
            ...
            HStack(alignment: .top, spacing: 12) {
                ...
                VStack(alignment: .leading, spacing: 4) {
                    Text("Action Button (iPhone 15 Pro+)")
                        .font(.subheadline.weight(.semibold))
                    Text("Settings → Action Button → Shortcut → Talk to GIGI")
                        .font(.caption)
                        .foregroundColor(.secondary)
                }
            }
            ...
            HStack(alignment: .top, spacing: 12) {
                ...
                VStack(alignment: .leading, spacing: 4) {
                    Text("Hey Siri")
                        .font(.subheadline.weight(.semibold))
                    Text("Say \"Hey Siri, talk to GIGI\" — works anywhere, no setup.")
                        .font(.caption)
                        .foregroundColor(.secondary)
                }
            }
