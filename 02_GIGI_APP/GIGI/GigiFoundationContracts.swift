...
struct FoundationRouterDecision {
    ...
    @Guide(description: "Canonical action name when path is native_tool, otherwise empty string. Allowed values: set_timer, set_alarm, set_reminder, send_message, make_call, facetime, navigate, play_music, open_app, weather, read_calendar, find_free_slot, read_email, homekit_on, homekit_off.")
